...
Key                 | English                                        | Deutsch                                        | 7360 124 | 7490 124 | 7490 171 | 7490 178 | GitHub0  | GitHub1  | Freifunk |
------------------- | ---------------------------------------------- | ---------------------------------------------- |:--------:|:--------:|:--------:|:--------:|:--------:|:--------:|:--------:|
1-adsl              | adsl                                           |                                                |          |          |          |          |          |     X    |     X    |
1-ath0              | ath0                                           | ath0                                           |     X    |     X    |     X    |     X    |     X    |     X    |     X    |
1-ath1              | ath1                                           | ath1                                           |          |     X    |     X    |     X    |          |     X    |          |
1-bat0              | bat0                                           |                                                |          |          |          |          |          |     X    |     X    |
1-dsl               | dsl                                            |                                                |          |          |          |          |          |     X    |          |
1-eth0              | eth0                                           | eth0                                           |     X    |     X    |     X    |     X    |     X    |     X    |     X    |
1-eth1              | eth1                                           | eth1                                           |     X    |     X    |     X    |     X    |     X    |     X    |          |
1-eth2              | eth2                                           | eth2                                           |     X    |     X    |     X    |     X    |     X    |     X    |          |
1-eth3              | eth3                                           | eth3                                           |     X    |     X    |     X    |     X    |     X    |     X    |     X    |
1-guest             | guest                                          | guest                                          |     X    |     X    |     X    |     X    |          |     X    |     X    |
...
1-wdsup1            | wdsup1                                         |                                                |          |          |          |          |          |     X    |
1-wifi0             | wifi0                                          | wifi0                                          |     X    |     X    |     X    |     X    |     X    |     X    |     X    |
1-wifi1             | wifi1                                          | wifi1                                          |          |     X    |     X    |     X    |          |     X    |     X    |
1-wlan              | wlan                                           | wlan                                           |          |     X    |     X    |     X    |          |     X    |
1-wlan_guest        | wlan_guest                                     | wlan_guest                                     |          |          |     X    |     X    |          |          |
2-1                 | 1. Internet connection                         | 1. Internetverbindung                          |     X    |     X    |     X    |     X    |     X    |          |
3-0                 | Routing interface                              | Routing-Schnittstelle                          |          |     X    |     X    |     X    |     X    |          |
3-17                | Interface 0 ('internet')                       | Schnittstelle 0 ('internet')                   |          |     X    |     X    |     X    |     X    |          |
...
4-131               | AP (2.4 GHz, ath0) - Interface 0               | AP (2.4 GHz, ath0) - Schnittstelle 0           |     X    |     X    |     X    |     X    |     X    |          |
...
GitHub0  | <https://github.com/rogerGunis/captureAvmFritzboxStream/blob/master/capture.sh>
GitHub1  | <https://github.com/bittorf/kalua/blob/master/TODO.txt>
